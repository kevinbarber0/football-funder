...
import {
  ...
  AdsListData,
  AdDetailClubCardLabelData,
  AdDetailLocationCardLabelData,
} from "Config";
import { DetailPagePropsType } from "types";
import ListImage from "Assets/images/detail/addetail.png";
...
export const AdDetail: React.FC<DetailPagePropsType> = ({ pending }) => {
  return (
    <Template>
        ...
        <div className="md:w-[670px] w-full px-5 max-bl:mx-auto">
          <div className="mt-5 valueText">
            ...
            <div className="mt-2.5 flex max-vs:flex-col gap-2.5">
              <VerticalCardLabel cardLabelData={AdDetailClubCardLabelData} />
              <VerticalCardLabel
                cardLabelData={AdDetailLocationCardLabelData}
              />
            </div>
          </div>
          <div className="mt-30 stepLabelTitle">
            Pitchside advertising board 1220x610cm
